...
const Projects = () => {
  ...
  const projects = [
    ...
    {
      title: "SPOTIFY-CLONE",
      description: "Introducing our Spotify clone: a sleek, user-friendly music streaming platform that brings your favorite tunes to life.",
      imgUrl: img2, 
      url: 'https://spotify-clone-0-1.netlify.app/'
    },
    
    {
      title: "TIC-TAC-TOE",
      description: "Experience the timeless fun of Tic Tac Toe with our modern twist on this classic game..",
      imgUrl: img4, 
      url: 'https://tic-tac-toe-game-o1.netlify.app/'
    },
