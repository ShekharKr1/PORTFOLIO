      ...
      <Navbar expand="md" className={scrolled ? "scrolled" : ""}>
        <Container>
          <Navbar.Brand href="#home">
            <h2 style={{color: '#fff', fontFamily: 'monospace san-serif', fontStyle: 'oblique', fontWeight: 'bold', fontSize: '2.5rem'} }>SHEKHAR</h2>
          </Navbar.Brand>
          ...
          <Navbar.Collapse id="basic-navbar-nav">
            ...
            <span className="navbar-text">
              <div className="social-icon nav-social">
                <Nav.Link href="https://www.linkedin.com/in/shekharkumar1/" target='_blank'><img src={navIcon1} alt="" /></Nav.Link>
                <Nav.Link href="https://github.com/ShekharKr1" target='_blank'><Github className='hii' color='white'/></Nav.Link>
                <Nav.Link href="https://www.instagram.com/_mr_shekhar128/" target='_blank'><img src={navIcon3} alt="" /></Nav.Link>
